...
import chemistry from '../mindmaps/chemistry.json'
import physics from '../mindmaps/physics.json'
import maths from '../mindmaps/maths.json'
   ...
   const scroll =()=>{
    ...
    return (
        < div className=''>
            ...
            <h1 style={{ fontFamily: "Manrope", fontSize: "30px", width: "95%", margin: "30px auto" }}>Find Below the Dpps of class 11 </h1>
